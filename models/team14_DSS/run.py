...
#****************need provide*********************
    ...
    script1_path = os.path.join(base_dir, 'models/team14_DSS/DiffBIR', 'inference.py')
    print(f"runing {script1_path} ...")    
    # 以当前文件夹为工作目录执行 main.py
    cwd_diffbir = os.path.join(base_dir, 'models/team14_DSS/DiffBIR')
    ...
    script2_path = os.path.join(base_dir, 'models/team14_DSS/StableSR/scripts', 'sr_val_ddpm_text_T_vqganfin_oldcanvas_tile.py')
    print(f"runing {script2_path} ...")    
    # 以当前文件夹为工作目录执行 main.py
    cwd_stablesr = os.path.join(base_dir, 'models/team14_DSS/StableSR')
    ...
    script3_path = os.path.join(base_dir, 'models/team14_DSS/SUPIR', 'test.py')
    print(f"runing {script3_path} ...")    
    # 以当前文件夹为工作目录执行 main.py
    cwd_supir = os.path.join(base_dir, 'models/team14_DSS/SUPIR')
